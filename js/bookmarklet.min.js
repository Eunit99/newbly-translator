javascript: (function () {
  /*! jQuery v3.5.1 | (c) JS Foundation and other
  ...
  !(function (e, t) {
    ...
    (x.filter = function (e, t, n) {
      ...
      x.fn.extend({
        ...
        is: function (e) {
          return !!H(
            this,
            "string" == typeof e && E.test(e) ? x(e) : e || [],
            !1
          ).length;
        },
      });
    ...
    function Ne(e, t, n, r) {
      ...
      if (
        ...
        if (c)
          for (
            u = s[s.length - 1].ownerDocument, x.map(s, Ie), d = 0;
            d < c;
            d++
          )
            (l = s[d]),
    ...
    x.extend({
      ...
      clone: function (e, t, n) {
        ...
        if (t)
          if (n)
            for (
              i = i || me(e), a = a || me(u), r = 0, o = i.length;
              r < o;
              r++
            )
              je(i[r], a[r]);
      ...
      trigger: function (t, n, r, o) {
        ...
        if (
          ...
          3 !== r.nodeType &&
            ...
            ((t = t[x.expando]
              ? t
              : new x.Event(y, "object" == typeof t && t)).isTrigger = o
              ? 2
              : 3),
            (t.namespace = b.join(".")),
        ...
        ajax: function (t, n) {
          ...
          function S(t, n, a, c) {
            ...
            l ||
              ...
              (b = void 0),
              u &&
                g.trigger(d ? "ajaxSuccess" : "ajaxError", [C, h, d ? f : m]),
              y.fireWith(p, [C, k]),
              u &&
    ...
    return (
      (x.noConflict = function (t) {
        return (
          e.$ === x && (e.$ = Vt), t && e.jQuery === x && (e.jQuery = Kt), x
        );
      }),
      ...
      e(["jquery"], function (e) {
        return (function () {
          ...
          function i(n) {
            ...
            function h() {
              var e =
                ((T.hideEta - new Date().getTime()) / T.maxHideTime) * 100;
              w.width(e + "%");
            }
            var p = a(),
      ...
      function Keycloak(e) {
        ...
        function h(e, t) {
          ...
          if (
            ...
            f.open("POST", d, !0),
              ...
              e.pkceCodeVerifier &&
                (u += "&code_verifier=" + e.pkceCodeVerifier),
              (f.withCredentials = !0),
        ...
        function g(e, t, n, o) {
          if (
            (r.tokenTimeoutHandle &&
              (clearTimeout(r.tokenTimeoutHandle),
              (r.tokenTimeoutHandle = null)),
            t
        ...
        function S(e) {
          if (!e || "default" == e)
            return {
              login: function (e) {
                return (
                  window.location.replace(r.createLoginUrl(e)), w().promise
                );
              },
              logout: function (e) {
                return (
                  window.location.replace(r.createLogoutUrl(e)), w().promise
                );
              },
              register: function (e) {
                return (
              ...
              logout: function (e) {
                ...
                return (
                  ...
                  a.addEventListener("loaderror", function (e) {
                    0 == e.url.indexOf("http://localhost") || (n = !0),
                      a.close();
                  }),
        ...
        (r.init = function (o) {
          ...
          r.responseMode || (r.responseMode = "fragment"),
            r.responseType ||
              ((r.responseType = "code"), (r.flow = "standard"));
          var a = w(),
            s = w();
          s.promise
            .then(function () {
          ...
          var l = (function (t) {
            ...
            if (
              (e ? "string" == typeof e && (n = e) : (n = "keycloak.json"), n)
            )
          ...
          (r.createLoginUrl = function (e) {
            ...
            if (
              ...
              e &&
                e.maxAge &&
                (h += "&max_age=" + encodeURIComponent(e.maxAge)),
              e &&
                e.loginHint &&
            ...
            localStorage.setItem("kc-test", "test"),
              ...
              (this.get = function (t) {
                if (t) {
                  ...
                  return (
                    r && (localStorage.removeItem(n), (r = JSON.parse(r))),
                    e(),
                    r
                  );
                }
      ...
      function T() {
        ...
        for (let t = 0; t < c.length; t++)
          c[t] === C() &&
            ((e = !0),
            console.log(
              "Newbly translation is available for: " + u().longLang
            ));
        return e;
      }
      var k = function () {
