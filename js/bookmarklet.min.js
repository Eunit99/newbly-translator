    ...
    init : function() {
      ...
      async function n() {
        ...
        for (let e = 0; e < n.length; e++) {
          ...
          n[e] && t &&
              (document.getElementById(`newbly-translated-text-${e}`)
                   .innerHTML = n[e])
        }
      }
      async function t() {
        let e = "", n = E(), t = await fetch(n), a = await t.json();
        return t.ok
                   ? (e = a.articleId, e)
                   : (console.error(
      ...
      document.head.innerHTML +=
          ...
          document.head.innerHTML +=
          '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.9/lib/css/style.min.css" type="text/css"/>',
          /MSIE \d|Trident.*rv:/.test(navigator.userAgent) &&
              document.write(
                  '<script src="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.9/lib/js/script.js"><\/script>'),
          document.head.innerHTML +=
          '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.9/vendor/toastr.min.css" type="text/css"/>',
          document.head.innerHTML +=
          '<script src="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.9/vendor/toastr.min.js"><\/script>',
          document.head.innerHTML +=
          '<script src="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.9/vendor/keycloak.min.js"><\/script>',
          setTimeout(
              (() => {Keycloak({
                 realm : "newbly",
      ...
      const o = () => {
        keycloak.idToken
            ...
            : keycloak.loadUserProfile(
                  (function() { console.log(keycloak.profile) }), (function() {
                    console.log(
                        "Failed to retrieve user details. Please enable claims or account role")
                  }))
      }, r = () => {
        keycloak.updateToken(30).then(o).catch((() => {
      ...
      var l = [ "ar", "hr", "en", "ro", "ru", "sr", "tr", "uk" ], s = {
        ar : {
      ...
      function c() {
        ...
        case "ar":
          ...
          l = g.ar.loginRegister, c = g.ar.authTextOne, u = g.ar.authTextTwo,
          d = g.ar.areYouSure;
          break;
        case "bh":
          ...
          l = g.bh.loginRegister, c = g.bh.authTextOne, u = g.bh.authTextTwo,
          d = g.bh.areYouSure;
          break;
        case "en":
        default:
          ...
          l = g.en.loginRegister, c = g.en.authTextOne, u = g.en.authTextTwo,
          d = g.en.areYouSure;
          break;
        case "fr":
          ...
          l = g.fr.loginRegister, c = g.fr.authTextOne, u = g.fr.authTextTwo,
          d = g.fr.areYouSure;
          break;
        case "hr":
          ...
          l = g.hr.loginRegister, c = g.hr.authTextOne, u = g.hr.authTextTwo,
          d = g.hr.areYouSure;
          break;
        case "ro":
          ...
          l = g.ro.loginRegister, c = g.ro.authTextOne, u = g.ro.authTextTwo,
          d = g.ro.areYouSure;
          break;
        case "ru":
          ...
          l = g.ru.loginRegister, c = g.ru.authTextOne, u = g.ru.authTextTwo,
          d = g.ru.areYouSure;
          break;
        case "sr":
          ...
          l = g.sr.loginRegister, c = g.sr.authTextOne, u = g.sr.authTextTwo,
          d = g.sr.areYouSure;
          break;
        case "tr":
          ...
          l = g.uk.loginRegister, c = g.uk.authTextOne, u = g.uk.authTextTwo,
          d = g.tr.areYouSure;
          break;
        case "uk":
        ...
        return g = longLang, function(e, n) {
          ...
          longLang: longLang, newblyUIModalLang: g, newblyModalTitle: e,
              ...
              discardChanges: r, loginRegister: l, authTextOne: c,
              authTextTwo: u, areYouSure: d
        }
      }
      var u = function(e, n) {
        ...
        document.body.innerHTML +=
            ...
            "ar" === k() &&
                document.getElementById("newbly-enhance-confirmation-modal")
                    .classList.add("arabic"),
            document.getElementById("are-you-sure").innerText = c().areYouSure,
            ...
            document.getElementById("newbly-textarea-modal-wrapper")
               ...
               function(e, n) {
                 ...
                 t.addEventListener(
                     "input", (function(e) {
                       o = e.target.value,
                       o !== n ? (a.classList.remove("disabled"), i = !0, C(!1))
      ...
      function C(e) { localStorage.setItem("@suggestionsSent", e) }
      var L = {
        includeTranslation : function() {
          document.getElementById("include-translation")
              .addEventListener(
                  "click", (function(e) {
                    A(), console.info("Newbly translation started!"), T(),
        ...
        cancelTranslations : function() {
          document.getElementById("cancel-translation")
              .addEventListener(
                  "click",
                  (function(
                      e) { console.info("Newbly translation cancelled"), T() }))
        }
      };
      function I() {
        ...
        if (t[1]) {
          function i() {
            let e, n = t[1];
            return e = n.includes(`&nLang=${v().targetLanguage}`)
      ...
      function E() {
        let e;
        return e = v().URLHasNLangParam
                       ? "https://api.newb.ly/articles/?language=" +
                             v().targetLanguage + "&url=" + I()
                       : "https://api.newb.ly/articles/?language=" +
                             c().longLang.toLowerCase() + "&url=" + I(),
               e
      }
      var B = function(e, n) { y(), d(n) },
          S =
              async function(e, o) {
            let r = document.getElementById("enhance-translations").value;
            !function(e, n) {
              ...
              document.getElementById(t).innerHTML = n
                ...
                await async function(e, t) {
                  ...
                  u.suggestions.push(u.suggestions.length),
                      localStorage.setItem(o, JSON.stringify(u)), await n()
                }(e, r),
                y(),
                setTimeout(
                    (() => {
                         keycloak
                             ...
                             .then((function(n) {
                               n ? JSON.parse(localStorage.getItem(
                                       "@suggestionsSent")) ||
                                       async function(e, n) {
                                         let a = await t(), i = {
          ...
          j = function(e) { m(), w() },
          M = function() { y(), m(), f(5, "translatedText") },
          O = function(e) { y(), b() },
          _ =
              function(e) {
            b(), setTimeout(
                     (() => {keycloak.init(
                          {onLoad : "login-required", flow : "implicit"})}),
                     3e3)
          },
          R = {
          ...
          A = function(e) {
            ...
            var o = function(e) {
              return l(e.articleTitle), s(e.articleContent), e
            }, l = function(e) { return u(e) && d(e), e }, s = function(e) {
              ...
              return document.body.textContent.includes(e)
                         ...
                         : (console.error("Texts do not exist on page: " + e),
                            !1)
            }, d = function(e) {
              const n = [
              ...
              !function() {
                var n = i.articleTitleTranslated, t = i.articleTitle;
                e.innerText === t &&
                    (g(null, e, n),
                     e.insertAdjacentHTML("beforeend", h(null, n)));
                var a = i.articleContentTranslated, o = i.articleContent;
              ...
              : function() {
                  ...
                  !v().URLHasNLangParam && x()
                      ? (document.getElementById("newbly-translation--ui-modal")
                         ...
                         document.getElementById("include-translation")
                             .innerText = c().newblyModalIncludeText,
                         document.getElementById("cancel-translation")
                             .innerText = c().newblyModalCancelText,
                         L.includeTranslation(), L.cancelTranslations(), e = !0)
                      : x() ||
                            (console.error(
