  ...
  var newbly = {
    init : function() {
      ...
      var c = function() {
        ...
        includeTranslation : function() {
          document.getElementById("include-translation")
              .addEventListener(
                  "click", (function(n) {
                    g(), console.info("Newbly translation started"), c()
                  }))
        },
      ...
      var g = function(a) {
        ...
        var r = function(n) {
          return s(n.articleTitle), o(n.articleContent), n
          ...
          "arabic" === t().targetLanguage ||
              ...
              ? (a.insertAdjacentHTML(
                     "beforeend",
                     "<p class='newbly-translated-text arabic'>" + l + "</p>"),
                 a.insertAdjacentHTML("beforeend", n(l)), e(l))
              : (a.insertAdjacentHTML("beforeend",
                                      "<p class='newbly-translated-text'>" + l +
                                          "</p>"),
                 a.insertAdjacentHTML("beforeend", n(l)), e(l))
        }, b = function(n) {
          !function() {
          ...
          console.info("Ξunit"), t().URLHasNLangParam ? g() : function() {
            ...
            !t().URLHasNLangParam && r()
                ? (document.getElementById("newbly-translation--ui-modal")
                   ...
                   document
                       .getElementById("newbly-translation--ui-modal__title")
