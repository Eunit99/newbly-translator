var newbly = {
  init : function() {
    ...
    async function n() {
      let e, n, t = await i();
      e = null !== t ? t.title : "", n = null !== t ? t.content : [],
    ...
    var r = [ "ar", "hr", "en", "ro", "ru", "sr", "tr", "uk" ], s = {
      ar : {
    ...
    function c() {
      let e, n, t, a, i, o, l, r, c, u, d, g = s;
      switch (k()) {
      case "ar":
        longLang = "Arabic", e = g.ar.title, n = g.ar.includeText,
        t = g.ar.notThisTime, a = g.ar.translationConsentText,
        i = g.ar.saveChanges, o = g.ar.cancel, l = g.ar.discardChanges,
        r = g.ar.loginRegister, c = g.ar.authTextOne, u = g.ar.authTextTwo,
        d = g.ar.areYouSure;
        break;
      case "bh":
        longLang = "Bihari", e = g.bh.title, n = g.bh.includeText,
        t = g.bh.notThisTime, a = g.bh.translationConsentText,
        i = g.bh.saveChanges, o = g.bh.cancel, l = g.bh.discardChanges,
        r = g.bh.loginRegister, c = g.bh.authTextOne, u = g.bh.authTextTwo,
        d = g.bh.areYouSure;
        break;
      case "en":
      default:
        ...
        i = g.en.saveChanges, o = g.en.cancel, l = g.en.discardChanges,
        r = g.en.loginRegister, c = g.en.authTextOne, u = g.en.authTextTwo,
        d = g.en.areYouSure;
        break;
      case "fr":
        longLang = "French", e = g.fr.title, n = g.fr.includeText,
        t = g.fr.notThisTime, a = g.fr.translationConsentText,
        i = g.fr.saveChanges, o = g.fr.cancel, l = g.fr.discardChanges,
        r = g.fr.loginRegister, c = g.fr.authTextOne, u = g.fr.authTextTwo,
        d = g.fr.areYouSure;
        break;
      case "hr":
        longLang = "Croatian", e = g.hr.title, n = g.hr.includeText,
        t = g.hr.notThisTime, a = g.hr.translationConsentText,
        i = g.hr.saveChanges, o = g.hr.cancel, l = g.hr.discardChanges,
        r = g.hr.loginRegister, c = g.hr.authTextOne, u = g.hr.authTextTwo,
        d = g.hr.areYouSure;
        break;
      case "ro":
        longLang = "Romanian", e = g.ro.title, n = g.ro.includeText,
        t = g.ro.notThisTime, a = g.ro.translationConsentText,
        i = g.ro.saveChanges, o = g.ro.cancel, l = g.ro.discardChanges,
        r = g.ro.loginRegister, c = g.ro.authTextOne, u = g.ro.authTextTwo,
        d = g.ro.areYouSure;
        break;
      case "ru":
        longLang = "Russian", e = g.ru.title, n = g.ru.includeText,
        t = g.ru.notThisTime, a = g.ru.translationConsentText,
        i = g.ru.saveChanges, o = g.ru.cancel, l = g.ru.discardChanges,
        r = g.ru.loginRegister, c = g.ru.authTextOne, u = g.ru.authTextTwo,
        d = g.ru.areYouSure;
        break;
      case "sr":
        longLang = "Serbian", e = g.sr.title, n = g.sr.includeText,
        t = g.sr.notThisTime, a = g.sr.translationConsentText,
        i = g.sr.saveChanges, o = g.sr.cancel, l = g.sr.discardChanges,
        r = g.sr.loginRegister, c = g.sr.authTextOne, u = g.sr.authTextTwo,
        d = g.sr.areYouSure;
        break;
      case "tr":
        longLang = "Turkish", e = g.tr.title, n = g.tr.includeText,
        t = g.tr.notThisTime, a = g.tr.translationConsentText,
        i = g.uk.saveChanges, o = g.uk.cancel, l = g.uk.discardChanges,
        r = g.uk.loginRegister, c = g.uk.authTextOne, u = g.uk.authTextTwo,
        d = g.tr.areYouSure;
        break;
      case "uk":
      ...
      return g = longLang, function(e, n) {
        ...
        longLang: longLang, newblyUIModalLang: g, newblyModalTitle: e,
            ...
            discardChanges: l, loginRegister: r, authTextOne: c, authTextTwo: u,
            areYouSure: d
      }
    }
    var u = function(e, n) {
    ...
    var B = function(e, n) { y(), d(n) },
          ...
          !function(e, n) {
            ...
            document.getElementById(t).innerHTML = n
              ...
              await async function(e, t) {
                const o = await a();
                let l, r, s, c = await i();
                l = null !== c ? c.title : "", r = null !== c ? c.content : [],
        ...
        A = function(e) {
          ...
          }, r = function(e) { return u(e) && d(e), e }, s = function(e) {
