var newbly = {
  init: function () {
      ...
      switch (k()) {
        case "ar":
          (longLang = "Arabic"),
            ...
            (i = g.ar.saveChanges),
            (o = g.ar.cancel),
            (r = g.ar.discardChanges),
            (l = g.ar.loginRegister),
            (s = g.ar.authTextOne),
            (u = g.ar.authTextTwo),
            (d = g.ar.areYouSure);
          break;
        case "bh":
          (longLang = "Bihari"),
            ...
            (i = g.bh.saveChanges),
            (o = g.bh.cancel),
            (r = g.bh.discardChanges),
            (l = g.bh.loginRegister),
            (s = g.bh.authTextOne),
            (u = g.bh.authTextTwo),
            (d = g.bh.areYouSure);
          break;
        ...
        default:
          (longLang = "English"),
            ...
            (i = g.en.saveChanges),
            (o = g.en.cancel),
            (r = g.en.discardChanges),
            (l = g.en.loginRegister),
            (s = g.en.authTextOne),
            (u = g.en.authTextTwo),
            (d = g.en.areYouSure);
          break;
        case "fr":
          (longLang = "French"),
            ...
            (i = g.fr.saveChanges),
            (o = g.fr.cancel),
            (r = g.fr.discardChanges),
            (l = g.fr.loginRegister),
            (s = g.fr.authTextOne),
            (u = g.fr.authTextTwo),
            (d = g.fr.areYouSure);
          break;
        case "hr":
          (longLang = "Croatian"),
            ...
            (i = g.hr.saveChanges),
            (o = g.hr.cancel),
            (r = g.hr.discardChanges),
            (l = g.hr.loginRegister),
            (s = g.hr.authTextOne),
            (u = g.hr.authTextTwo),
            (d = g.hr.areYouSure);
          break;
        case "ro":
          (longLang = "Romanian"),
            ...
            (i = g.ro.saveChanges),
            (o = g.ro.cancel),
            (r = g.ro.discardChanges),
            (l = g.ro.loginRegister),
            (s = g.ro.authTextOne),
            (u = g.ro.authTextTwo),
            (d = g.ro.areYouSure);
          break;
        case "ru":
          (longLang = "Russian"),
            ...
            (i = g.ru.saveChanges),
            (o = g.ru.cancel),
            (r = g.ru.discardChanges),
            (l = g.ru.loginRegister),
            (s = g.ru.authTextOne),
            (u = g.ru.authTextTwo),
            (d = g.ru.areYouSure);
          break;
        case "sr":
          (longLang = "Serbian"),
            ...
            (i = g.sr.saveChanges),
            (o = g.sr.cancel),
            (r = g.sr.discardChanges),
            (l = g.sr.loginRegister),
            (s = g.sr.authTextOne),
            (u = g.sr.authTextTwo),
            (d = g.sr.areYouSure);
          break;
        case "tr":
          (longLang = "Turkish"),
            ...
            (i = g.uk.saveChanges),
            (o = g.uk.cancel),
            (r = g.uk.discardChanges),
            (l = g.uk.loginRegister),
            (s = g.uk.authTextOne),
            (u = g.uk.authTextTwo),
            (d = g.tr.areYouSure);
          break;
        ...
        d(e, n),
          ...
          (function (e, n) {
            ...
            t.addEventListener("input", function (e) {
              (o = e.target.value),
                o !== n
                  ? (a.classList.remove("disabled"), (i = !0), L(!1))
    ...
    var I = {
      ...
      cancelTranslations: function () {
        document
          ...
          .addEventListener("click", function (e) {
            console.info("Newbly translation cancelled"), w();
          });
      },
    };
    function E() {
    ...
    var S = function (e, n) {
        ...
        !(function (e, n) {
          ...
          await (async function (e, n) {
            ...
            let r,
              ...
              c = await o();
            (r = c.title ? c.title : ""),
              (l = c.content ? c.content : []),
              (s = c.suggestions ? c.suggestions : []);
            let u = { title: r, suggestions: s, content: l };
            null === e && (u.title = n),
              null !== e &&
                (u.content[e] ? u.content.splice(e, 1, n) : u.content.push(n));
              ...
              t
                ? JSON.parse(localStorage.getItem("@suggestionsSent")) ||
                  (async function (e, t) {
                    ...
                    fetch(`https://api.newb.ly/articles/${i}/suggestion`, r)
                      .then((e) => {
                        if (!e.ok) throw (L(!1), Error(e.status));
                        return e.json();
                      })
                      .then((e) => {
                        console.info(
      ...
      R = function (e) {
        T(), n.init({ onLoad: "login-required", flow: "implicit" });
      },
      A = {
      ...
      z = function (e) {
        ...
        var r = function (e) {
          ...
          c = function (e) {
            for (let n = 0; n < e.length; n++) d(e[n]) && g(e[n]);
            return e;
          },
          d = function (e) {
          ...
          y = function (e) {
            !(function () {
              var n = o.articleTitleTranslated,
                t = o.articleTitle;
              e.innerText === t &&
                (h(null, e, n), e.insertAdjacentHTML("beforeend", m(null, n)));
              var a = o.articleContentTranslated,
                i = o.articleContent;
        ...
        : (function () {
            ...
            !x().URLHasNLangParam && p()
              ? ((document.getElementById(
                ...
                I.includeTranslation(),
                I.cancelTranslations(),
                (e = !0))
              : p() ||
                (console.error(
