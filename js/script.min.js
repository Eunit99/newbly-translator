  ...
  init: function () {
      ...
      e = function (n) {
        document
          ...
          .addEventListener("click", function (e) {
            const t = document.getElementById("newbly-textarea-modal-wrapper"),
    ...
    function r() {
      ...
      for (let e = 0; e < a.length; e++)
        a[e] === o() &&
          ((n = !0),
          console.log("Newbly translation is available for: " + i().longLang));
      return n;
    }
    var s = function () {
      var n,
      ...
      if (Array.isArray(t.languages))
        for (n = 0; n < t.languages.length; n++)
          if ((e = t.languages[n]) && e.length) return e;
      for (n = 0; n < a.length; n++) if ((e = t[a[n]]) && e.length) return e;
      return null;
    };
    function o() {
      let n,
      ...
      u = {
        ...
        cancelTranslations: function () {
          document
            ...
            .addEventListener("click", function (n) {
              console.info("Newbly translation cancelled"), c();
            });
        },
      };
    function d() {
      ...
      if (e[1]) {
        function l() {
          let n,
            a = e[1];
          return (
            (n = a.includes(`&nLang=${t().targetLanguage}`)
    ...
    var g = function (a) {
      ...
      !(async function (n) {
        ...
        (function () {
          let n;
          return (
            (n = t().URLHasNLangParam
              ? "https://api.newb.ly/articles/?language=" +
                t().targetLanguage +
                "&url=" +
                d()
              : "https://api.newb.ly/articles/?language=" +
                i().longLang.toLowerCase() +
                "&url=" +
                d()),
            n
          );
      ...
      var r = function (n) {
        ...
        o = function (n) {
          for (let e = 0; e < n.length; e++) c(n[e]) && u(n[e]);
          return n;
        },
        c = function (n) {
        ...
        g = function (a, l) {
          ...
          "arabic" === i().longLang.toLowerCase()
            ? (a.insertAdjacentHTML(
              ...
              a.insertAdjacentHTML("beforeend", n(l)),
              e(l))
            : (a.insertAdjacentHTML(
                "beforeend",
                "<p class='newbly-translated-text'>" + l + "</p>"
              ),
              a.insertAdjacentHTML("beforeend", n(l)),
              e(l));
        },
        b = function (n) {
          !(function () {
            var e = l.articleTitleTranslated,
              t = l.articleTitle;
            n.innerText === t && g(n, e);
            var a = l.articleContentTranslated,
              i = l.articleContent;
        ...
        : (function () {
            ...
            !t().URLHasNLangParam && r()
              ? ((document.getElementById(
                ...
                u.includeTranslation(),
                u.cancelTranslations(),
                (n = !0))
              : r() ||
                (console.error(
