var newbly = {
  init : function() {
    document.head.innerHTML +=
        '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.7/lib/css/style.min.css" type="text/css"/>',
        /MSIE \d|Trident.*rv:/.test(navigator.userAgent) &&
            document.write(
                '<script src="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.7/lib/js/script.js"><\/script>'),
              ...
              "click", (function(e) {
                const t =
                    document.getElementById("newbly-textarea-modal-wrapper"),
                      a = document.getElementById("enhance-translations");
                t.style.display = "flex", a.value = n, console.log(n)
              }))
    };
    function t() {
      let n, e;
      ...
      return a.has("nLang") || a.has("nlang")
                 ? (n = a.get("nLang") || a.get("nlang"), e = !0)
                 : a.has("nLang") && a.has("nlang") || (n = "english", e = !1),
      {
        targetLanguage: n, URLHasNLangParam: e
      }
    }
    var a = [ "ar", "hr", "en", "ro", "ru", "sr", "tr", "uk" ], l = {
      ar : {
    ...
    function i() {
      ...
      switch (o()) {
      case "ar":
        longLang = "Arabic", n = i.ar.title, e = i.ar.includeText,
        t = i.ar.cancelText, a = i.ar.translationConsentText;
        break;
      case "bh":
        longLang = "Bihari", n = i.bh.title, e = i.bh.includeText,
        t = i.bh.cancelText, a = i.bh.translationConsentText;
        break;
      case "en":
      default:
        longLang = "English", n = i.en.title, e = i.en.includeText,
        t = i.en.cancelText, a = i.en.translationConsentText;
        break;
      case "fr":
        longLang = "French", n = i.fr.title, e = i.fr.includeText,
        t = i.fr.cancelText, a = i.fr.translationConsentText;
        break;
      case "hr":
        longLang = "Croatian", n = i.hr.title, e = i.hr.includeText,
        t = i.hr.cancelText, a = i.hr.translationConsentText;
        break;
      case "ro":
        longLang = "Romanian", n = i.ro.title, e = i.ro.includeText,
        t = i.ro.cancelText, a = i.ro.translationConsentText;
        break;
      case "ru":
        longLang = "Russian", n = i.ru.title, e = i.ru.includeText,
        t = i.ru.cancelText, a = i.ru.translationConsentText;
        break;
      case "sr":
        longLang = "Serbian", n = i.sr.title, e = i.sr.includeText,
        t = i.sr.cancelText, a = i.sr.translationConsentText;
        break;
      case "tr":
        longLang = "Turkish", n = i.tr.title, e = i.tr.includeText,
        t = i.tr.cancelText, a = i.tr.translationConsentText;
        break;
      case "uk":
        longLang = "Ukrainian", n = i.uk.title, e = i.uk.includeText,
        t = i.uk.cancelText, a = i.uk.translationConsentText
      }
      return i = longLang, {
        longLang: longLang, newblyUIModalLang: i, newblyModalTitle: n,
            newblyTranslationConsentText: a, newblyModalIncludeText: e,
    ...
    function o() {
      let n, e = s();
      return n = -1 !== e.indexOf("-")   ? e.split("-")[0]
                 : -1 !== e.indexOf("_") ? e.split("_")[0]
                                         : e,
             n
    }
    var c = function() {
      ...
      includeTranslation : function() {
        document.getElementById("include-translation")
            .addEventListener("click", (function(n) {
                                g(), console.info("Newbly translation started"),
                                    c()
                              }))
      },
      cancelTranslations : function() {
        document.getElementById("cancel-translation")
            .addEventListener(
                "click",
                (function(
                    n) { console.info("Newbly translation cancelled"), c() }))
      }
    };
    function d() {
      let n, e = window.location.href.split("?"), a = e[0];
      if (e[1]) {
        function l() {
          let n, a = e[1];
          return n = a.includes(`&nLang=${t().targetLanguage}`)
                         ? a.replace(`&nLang=${t().targetLanguage}`, "")
                     : a.includes(`?nLang=${t().targetLanguage}`)
                         ? a.replace(`?nLang=${t().targetLanguage}`, "")
                     : a === `nLang=${t().targetLanguage}` ? ""
                                                           : a,
                 n
        }
        n = l() ? a + "?" + l() : a
    ...
    var g = function(a) {
      let l = "";
      !async function(n) {
        l = await async function(n) {
          let e = await fetch(n);
          return await e.json()
        }(n), r(l)
      }(function() {
        let n;
        return n = t().URLHasNLangParam
                       ? "https://api.newb.ly/articles/?language=" +
                             t().targetLanguage + "&url=" + d()
                       : "https://api.newb.ly/articles/?language=" +
                             i().longLang.toLowerCase() + "&url=" + d(),
               n
      }());
      var r = function(n) { return s(n.articleTitle), o(n.articleContent), n },
          s = function(n) { return c(n) && u(n), n }, o = function(n) {
            for (let e = 0; e < n.length; e++)
              c(n[e]) && u(n[e]);
            return n
          }, c = function(n) {
            return document.body.textContent.includes(n)
                       ? (console.info("Texts exist on page: " + n), !0)
                       : (console.error("Texts do not exist on page: " + n), !1)
          }, u = function(n) {
            const e = [
            ...
            for (let i = 0; i < e.length; i++) {
              var l = e[i];
              for (var l of document.querySelectorAll(l))
                l.textContent.includes(n) &&
                    (a.push(l), t = a[a.length - 1], b(t, t.innerText))
            }
            return t.innerText
          }, g = function(a, l) {
            "arabic" === t().targetLanguage ||
                    "arabic" === i().longLang.toLowerCase()
                ? (a.insertAdjacentHTML(
                       "beforeend",
                       "<p class='newbly-translated-text arabic'>" + l +
                           "</p>"),
                   a.insertAdjacentHTML("beforeend", n(l)), e(l))
            ...
            !function() {
              var e = l.articleTitleTranslated, t = l.articleTitle;
              n.innerText === t && g(n, e);
              var a = l.articleContentTranslated, i = l.articleContent;
              for (let e = 0; e < i.length; e++)
                n.innerText === i[e] && g(n, a[e])
            }()
          }
    };
    console.log(
        "Newbly translation initialized. Learn more here: https://newb.ly/"),
        console.info("Ξunit"), t().URLHasNLangParam ? g() : function() {
          let n;
          !t().URLHasNLangParam && r()
