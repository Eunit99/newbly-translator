var newbly = {
  init : function() {
    ...
    document.head.innerHTML +=
        ...
        document.head.innerHTML +=
        '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.8/lib/css/style.min.css" type="text/css"/>',
        /MSIE \d|Trident.*rv:/.test(navigator.userAgent) &&
            document.write(
                '<script src="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.8/lib/js/script.js"><\/script>'),
        document.head.innerHTML +=
        '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.8/vendor/toastr.min.css" type="text/css"/>',
        document.head.innerHTML +=
        '<script src="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.8/vendor/toastr.min.js"><\/script>',
        document.head.innerHTML +=
        '<script src="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.8/vendor/keycloak.min.js"><\/script>';
    const n = Keycloak({
      realm : "newbly",
    ...
    async function t() {
      let e, n, t = await o();
      e = t.title ? t.title : "", n = t.content ? t.content : [],
    ...
    async function a() {
      let e = "", n = B(), t = await fetch(n), a = await t.json();
      return t.ok
                 ? (e = a.articleId, e)
                 : (console.error(
    ...
    const r = () => {
      n.idToken
          ? console.log(n.idTokenParsed)
          : n.loadUserProfile(
                (function() { console.log(n.profile) }), (function() {
                  console.log(
                      "Failed to retrieve user details. Please enable claims or account role")
                }))
    }, l = () => {
      n.updateToken(30).then(r).catch((() => {
    ...
    var s = [ "ar", "hr", "en", "ro", "ru", "sr", "tr", "uk" ], c = {
      ar : {
    ...
    function u() {
      let e, n, t, a, i, o, r, l, s, u, d, g = c;
      switch (k()) {
      case "ar":
        longLang = "Arabic", e = g.ar.title, n = g.ar.includeText,
        t = g.ar.notThisTime, a = g.ar.translationConsentText,
        i = g.ar.saveChanges, o = g.ar.cancel, r = g.ar.discardChanges,
        l = g.ar.loginRegister, s = g.ar.authTextOne, u = g.ar.authTextTwo,
        d = g.ar.areYouSure;
        break;
      case "bh":
        longLang = "Bihari", e = g.bh.title, n = g.bh.includeText,
        t = g.bh.notThisTime, a = g.bh.translationConsentText,
        i = g.bh.saveChanges, o = g.bh.cancel, r = g.bh.discardChanges,
        l = g.bh.loginRegister, s = g.bh.authTextOne, u = g.bh.authTextTwo,
        d = g.bh.areYouSure;
        break;
      case "en":
      default:
        longLang = "English", e = g.en.title, n = g.en.includeText,
        t = g.en.notThisTime, a = g.en.translationConsentText,
        i = g.en.saveChanges, o = g.en.cancel, r = g.en.discardChanges,
        l = g.en.loginRegister, s = g.en.authTextOne, u = g.en.authTextTwo,
        d = g.en.areYouSure;
        break;
      case "fr":
        longLang = "French", e = g.fr.title, n = g.fr.includeText,
        t = g.fr.notThisTime, a = g.fr.translationConsentText,
        i = g.fr.saveChanges, o = g.fr.cancel, r = g.fr.discardChanges,
        l = g.fr.loginRegister, s = g.fr.authTextOne, u = g.fr.authTextTwo,
        d = g.fr.areYouSure;
        break;
      case "hr":
        longLang = "Croatian", e = g.hr.title, n = g.hr.includeText,
        t = g.hr.notThisTime, a = g.hr.translationConsentText,
        i = g.hr.saveChanges, o = g.hr.cancel, r = g.hr.discardChanges,
        l = g.hr.loginRegister, s = g.hr.authTextOne, u = g.hr.authTextTwo,
        d = g.hr.areYouSure;
        break;
      case "ro":
        longLang = "Romanian", e = g.ro.title, n = g.ro.includeText,
        t = g.ro.notThisTime, a = g.ro.translationConsentText,
        i = g.ro.saveChanges, o = g.ro.cancel, r = g.ro.discardChanges,
        l = g.ro.loginRegister, s = g.ro.authTextOne, u = g.ro.authTextTwo,
        d = g.ro.areYouSure;
        break;
      case "ru":
        longLang = "Russian", e = g.ru.title, n = g.ru.includeText,
        t = g.ru.notThisTime, a = g.ru.translationConsentText,
        i = g.ru.saveChanges, o = g.ru.cancel, r = g.ru.discardChanges,
        l = g.ru.loginRegister, s = g.ru.authTextOne, u = g.ru.authTextTwo,
        d = g.ru.areYouSure;
        break;
      case "sr":
        longLang = "Serbian", e = g.sr.title, n = g.sr.includeText,
        t = g.sr.notThisTime, a = g.sr.translationConsentText,
        i = g.sr.saveChanges, o = g.sr.cancel, r = g.sr.discardChanges,
        l = g.sr.loginRegister, s = g.sr.authTextOne, u = g.sr.authTextTwo,
        d = g.sr.areYouSure;
        break;
      case "tr":
        longLang = "Turkish", e = g.tr.title, n = g.tr.includeText,
        t = g.tr.notThisTime, a = g.tr.translationConsentText,
        i = g.uk.saveChanges, o = g.uk.cancel, r = g.uk.discardChanges,
        l = g.uk.loginRegister, s = g.uk.authTextOne, u = g.uk.authTextTwo,
        d = g.tr.areYouSure;
        break;
      case "uk":
        longLang = "Ukrainian", e = g.uk.title, n = g.uk.includeText,
        t = g.uk.notThisTime, a = g.uk.translationConsentText,
        i = g.uk.saveChanges, o = g.uk.cancel, r = g.uk.discardChanges,
        l = g.uk.loginRegister, s = g.uk.authTextOne, u = g.uk.authTextTwo,
        d = g.uk.areYouSure
      }
      return g = longLang, function(e, n) {
        let t = {code : e, name : n, native : n};
        localStorage.setItem("@language", JSON.stringify(t))
      }(k(), longLang), {
        longLang: longLang, newblyUIModalLang: g, newblyModalTitle: e,
            newblyTranslationConsentText: a, newblyModalIncludeText: n,
            newblyModalCancelText: t, saveChanges: i, cancel: o,
            discardChanges: r, loginRegister: l, authTextOne: s, authTextTwo: u,
            areYouSure: d
      }
    }
    var d = function(e, n) {
      ...
      document.body.innerHTML +=
          ...
          document.getElementById("enhance-newbly-auth-wrapper").style.display =
              "flex",
          "ar" === k() && document.getElementById("enhance-newbly-auth-wrapper")
                              .classList.add("arabic"),
    ...
    var m = function(e, n) {
          ...
          document.getElementById("newbly-textarea-modal-wrapper")
             ...
             function(e, n) {
               ...
               t.addEventListener(
                   "input", (function(e) {
                     o = e.target.value,
                     o !== n ? (a.classList.remove("disabled"), i = !0, L(!1))
      ...
      setTimeout((() => {document.getElementById(t).addEventListener(
                      "click", (function(t) { f(e, n) }))}),
                 1e3)
    };
    function x() {
      let e, n;
      const t = window.location.search, a = new URLSearchParams(t);
      return a.has("nLang") || a.has("nlang")
                 ? (e = a.get("nLang") || a.get("nlang"), n = !0)
                 : a.has("nLang") && a.has("nlang") || (e = "english", n = !1),
      {
        targetLanguage: e, URLHasNLangParam: n
      }
    }
    function p() {
      let e;
    ...
    function k() {
      let e, n = C();
      return e = -1 !== n.indexOf("-")   ? n.split("-")[0]
                 : -1 !== n.indexOf("_") ? n.split("_")[0]
                                         : n,
             e
    }
    function L(e) { localStorage.setItem("@suggestionsSent", e) }
    var I = {
      includeTranslation : function() {
        document.getElementById("include-translation")
            .addEventListener(
                "click", (function(e) {
                  z(), console.info("Newbly translation started!"), w(),
      ...
      cancelTranslations : function() {
        document.getElementById("cancel-translation")
            .addEventListener(
                "click",
                (function(
                    e) { console.info("Newbly translation cancelled"), w() }))
      }
    };
    function E() {
      let n, t = e().split("?"), a = t[0];
      if (t[1]) {
        function i() {
          let e, n = t[1];
          return e = n.includes(`&nLang=${x().targetLanguage}`)
                         ? n.replace(`&nLang=${x().targetLanguage}`, "")
    ...
    function B() {
      ...
      return e = x().URLHasNLangParam
                     ? "https://api.newb.ly/articles/?language=" +
                           x().targetLanguage + "&url=" + E()
                     : "https://api.newb.ly/articles/?language=" +
                           u().longLang.toLowerCase() + "&url=" + E(),
             e
    }
    var S = function(e, n) { y(), g(n) },
        j =
            async function(e, r) {
          ...
          !function(e, n) {
            ...
            document.getElementById(t).innerHTML = n
              ...
              await async function(e, n) {
                const a = await i();
                let r, l, s, c = await o();
                r = c.title ? c.title : "", l = c.content ? c.content : [],
                s = c.suggestions ? c.suggestions : [];
                let u = {title : r, suggestions : s, content : l};
                null === e && (u.title = n),
                    null !== e && (u.content[e] ? u.content.splice(e, 1, n)
                                                : u.content.push(n));
                u.suggestions.push(u.suggestions.length),
                    localStorage.setItem(a, JSON.stringify(u)), await t()
              }(e, l),
              y(),
              n.init({onLoad : "check-sso", flow : "implicit"})
                  .then((function(t) {
                    t ? JSON.parse(localStorage.getItem("@suggestionsSent")) ||
                            async function(e, t) {
                              let i = await a(), o = {
                                articleContentIndex : e,
                                articleTranslatedPartCorrection : t
                              };
                              const r = {
                                method : "PATCH",
                                headers : {
        ...
        z = function(e) {
          ...
          !async function(e) {
            o = await async function(e) {
              let n = await fetch(e), t = await n.json();
              return n.ok
                         ? t
                         : (console.error(
          ...
          var r = function(e) {
            return s(e.articleTitle), c(e.articleContent), e
          }, s = function(e) { return d(e) && g(e), e }, c = function(e) {
            ...
            if (n.insertAdjacentHTML(
              ...
              for (const n of e)
                n.classList.add("arabic")
            }
          }, y = function(e) {
            !function() {
              var n = o.articleTitleTranslated, t = o.articleTitle;
              e.innerText === t &&
                  (h(null, e, n),
                   e.insertAdjacentHTML("beforeend", m(null, n)));
              var a = o.articleContentTranslated, i = o.articleContent;
              for (let n = 0; n < i.length; n++)
                e.innerText === i[n] &&
                    (h(n, e, a[n]),
                     e.insertAdjacentHTML("beforeend", m(n, a[n])))
            }()
          };
          n.init({onLoad : "check-sso", flow : "implicit"}).then(l),
              async function() {
                let e = await i(), n = await a();
                e === `${u().longLang.toLowerCase()}_${n}` && await t()
              }()
        };
    console.log(
            ...
            : function() {
                ...
                !x().URLHasNLangParam && p()
                    ? (document.getElementById("newbly-translation--ui-modal")
                       ...
                       I.includeTranslation(), I.cancelTranslations(), e = !0)
                    : p() ||
                          (console.error(
