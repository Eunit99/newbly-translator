...
var newbly = {
  init: function init() {
    ...
    */
    ...
    var release = "1.0.7"; // Current release version
    ...
    var IEScript = "https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@" + release + "/lib/js/script.js"; // Link to hosted script compatible with IE 11
    ...
    */
    ...
    var enhanceNewbly = {
      editIconContainer: function editIconContainer() {
        var editIcon = "\n          <!-- Edit icons -->\n          <span class=\"newbly-translated-text edit-icon\" id=\"edit-icon\">\n            <img src=\"" + editIconLink + "\" alt=\"Edit\">\n          </span>\n          <!-- Edit icons -->\n        ";

        return editIcon;
      },

      displayNewblyTextarea: function displayNewblyTextarea(content) {

        document.getElementById("edit-icon").addEventListener("click", function (e) {

          var textareaModal = document.getElementById("newbly-textarea-modal-wrapper");
    ...
    */
    ...
    var startNewblyTranslation = function startNewblyTranslation(fetchURL) {
      var fetchArticleFromBackend = function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(fetchURL) {
          var response, data;
      ...
      var fetchFnc = function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(fetchURL) {
      ...
      var appendTranslation = function appendTranslation(container, translatedText) {
