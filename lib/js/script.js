...
var newbly = {
  init: function init() {
    ...
    var IEScript =
      "https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@" +
      release +
      "/lib/js/script.js"; // Link to hosted script compatible with IE 11
    var editIconLink =
      "https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@" +
      release +
      ...
      displayNewblyTextarea: function displayNewblyTextarea(content) {
        document
          ...
          .addEventListener("click", function (e) {
            var textareaModal = document.getElementById(
    ...
    var startNewblyTranslation = function startNewblyTranslation(fetchURL) {
      var fetchArticleFromBackend = (function () {
        var _ref = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee(fetchURL) {
            var response, data;
      ...
      var fetchFnc = (function () {
        var _ref2 = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(fetchURL) {
            return regeneratorRuntime.wrap(
      ...
      var appendTranslation = function appendTranslation(
        ...
        if (
          ...
          container.insertAdjacentHTML(
            "beforeend",
            "<p class='newbly-translated-text arabic'>" +
              translatedText +
              "</p>"
          );
          ...
          container.insertAdjacentHTML(
            "beforeend",
            enhanceNewbly.editIconContainer(translatedText)
          );
          ...
          container.insertAdjacentHTML(
            "beforeend",
            "<p class='newbly-translated-text'>" + translatedText + "</p>"
          );
