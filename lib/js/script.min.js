  ...
  init: function () {
    ...
    function x() {
      ...
      for (let n = 0; n < l.length; n++)
        l[n] === k() &&
          ((e = !0),
          console.log("Newbly translation is available for: " + c().longLang));
      return e;
    }
    var p = function () {
      var e,
    ...
    var B = function (e, n) {
      ...
      A = function (e) {
          ...
          y = function (e) {
            !(function () {
              var n = i.articleTitleTranslated,
                t = i.articleTitle;
              e.innerText === t &&
                (g(null, e, n), e.insertAdjacentHTML("beforeend", h(null, n)));
        ...
        setTimeout(() => {
          keycloak.init({ onLoad: "check-sso", flow: "implicit" }).then(r);
        }, 3e3),
          (async function () {
            let e = await a(),
              i = await t();
