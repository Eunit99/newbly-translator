var newbly = {
  init : function() {
    document.head.innerHTML +=
        '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.5/lib/css/style.min.css" type="text/css"/>',
        /MSIE \d|Trident.*rv:/.test(navigator.userAgent) &&
            document.write(
                '<script src="https://cdn.jsdelivr.net/gh/eunit99/newbly-translator@1.0.5/lib/js/script.js"><\/script>'),
